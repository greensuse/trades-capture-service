...
class InstructionRawTest {

    @Test
    void testPojoContract() {
        try {
            Class<?> cls = Class.forName("com.example.trades.model.InstructionRaw");
            ...
            fail("Class com.example.trades.model.InstructionRaw not found");
        } catch (Exception e) {
            fail("Failed to construct or test InstructionRaw: " + e.getMessage());
        }
    }
