...
class PlatformTradeTest {
    ...
    void testPojoContract() {
        try {
            Class<?> cls = Class.forName("com.example.trades.model.PlatformTrade");
            ...
            fail("Class com.example.trades.model.PlatformTrade not found");
        } catch (Exception e) {
            fail("Failed to construct or test PlatformTrade: " + e.getMessage());
        }
    }
    ...
    private Object createInstance(Class<?> cls) throws Exception {
        ...
        // Otherwise pick first constructor and supply defaults
